...
const dummy = ref(
    '<html>The PPIP should include, but not be limited to, the following information: <ul> <li>in detail, the processes, procedures, analyses, and facilities how the project will incorporate for the required planetary protection,</li></ul></html>'
);
</script>
